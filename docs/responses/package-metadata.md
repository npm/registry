...
This form of the package metadata exists to provide a smaller payload designed to support installation. It contains a subset of fields from the full metadata set. The top-level fields are:
